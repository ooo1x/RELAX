...
Execution in the static environment: [docs/videos/static.mp4](docs/videos/static.mp4)
...
Execution in the dynamic environment: [docs/videos/dynamic.mp4](docs/videos/dynamic.mp4)
